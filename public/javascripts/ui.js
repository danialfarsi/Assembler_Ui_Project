...
class UI {
    ...
    addToHis(text){
        ...
        his.innerHTML += `<textarea id="his-val" class="form-control mb-2" style="text-decoration:none "rows="5" style="overflow: scroll;font-size: 0.1rem;" disabled>${text}</textarea>`
    }
}